...
const LandingPage = () => {
  ...
  return (
    <div className="w-full min-h-screen text-white font-sans overflow-x-hidden selection:bg-neon-cyan selection:text-black relative">

      {/* Background Image Container using Framer Motion */}
      <motion.div 
      ...
      <div className="relative z-10">
        ...
        {/* Hero Section */}
        <section className="relative pt-40 pb-20 px-8 flex flex-col items-center justify-center min-h-[90vh]">
        ...
        {/* The Problem Section */}
        <section className="py-24 px-8 border-t border-white/5 bg-[#0a0a0f]/60 backdrop-blur-md">
        ...
        <section className="py-24 px-8 border-t border-white/5 bg-tactical-dark/60 backdrop-blur-md">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
