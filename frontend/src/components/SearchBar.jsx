...
export default function SearchBar() {
  ...
  const { initiateSearch } = useAppContext();
  ...
  return (
    ...
    <div className="absolute top-6 left-1/2 transform -translate-x-1/2 z-50 pointer-events-auto flex gap-2 bg-gray-900/80 p-2 rounded-lg border border-gray-700 shadow-[0_0_15px_rgba(0,0,0,0.5)]">
